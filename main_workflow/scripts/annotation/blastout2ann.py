...
def parse_args(args):
    ...
    base_group.add_argument("--identity", type=float, dest="identity", metavar="identity", default=0.5)
    ...
    with open(f_out, "w") as f:
        ...
        for blastout in f_in:
            ...
            for query in blast_root.iter_query():
                ...
                if lim_eval < e_val:
                    continue
                if lim_identity > (identity/query.len):
                    continue
                f.write(text.format(
